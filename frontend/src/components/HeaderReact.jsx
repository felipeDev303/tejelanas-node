  ...
  return (
    <header className="w-full max-w-[1440px] mx-auto px-6 py-3 bg-white/80 backdrop-blur-md shadow-lg rounded-b-2xl flex items-center justify-between sticky top-0 z-50 transition-all border-b border-pink-100">
      ...
      >
        ...
        />
        <span className="text-2xl font-extrabold text-pink-700 tracking-tight whitespace-nowrap font-sans">
          tejelanasvivi.cl
        </span>
      </a>
      <nav className="hidden md:flex gap-8 text-lg">
        <a
          href="/#sobre-nosotros"
          className="text-gray-700 hover:text-pink-700 font-semibold transition-colors"
        >
          Sobre Nosotros
        </a>
        <a
